...
1. **Download the installer (~117 MB).**  
   You can also browse all versions on the [Releases](https://github.com/AiMaster69/TrustSpectra/releases) page.

   [![Download v0.9.0](https://img.shields.io/badge/Download-v0.9.0-blue?style=for-the-badge&logo=github)](https://github.com/AiMaster69/TrustSpectra/releases/download/v0.9.0/TrustSpectra_v0.9.0_setup.exe)  
